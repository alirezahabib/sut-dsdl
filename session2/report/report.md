...
U
می‌کنیم.
تصویری از مدار نهایی شمارنده در صفحه‌ی بعد آمده است.
...
در صفحه‌ی بعد طراحی شماتیک کلی آمده است.
...
در حین کار برای debugging متغییرهای مدار را به صورت خروجی اضافه کردم که همگی در انتها پسوند `debug_` دارند. برای فهم بهتر خروجی‌ها این متغیرها را در انتها حذف نکردم. هر چند جزو خواسته‌ی سوال نیستند و خروجی‌های اصلی مدار `open1` و `close` است. در ادامه خروجی کامل موج مدار آمده است.
